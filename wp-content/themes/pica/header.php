<?php 
	...
	//We love our quotes
	$quotes = array ('Trust your developer', 'I shot the serif', 'make pixels not war', 'meeeow', 'do or do not', 'there is no try', 'be the spoon', 'be bold', 'be different');
...
<html>
    <head>    
        ...
        <!-- Icon for iPads -->
        <link rel="apple-touch-icon" sizes="72x72" href="<?php bloginfo('template_directory')?>/images/icons/pica-avatar-72px.png" />
